...
public class SortedByPhoneNamePage extends PageFactory {
    ...
    //public static final String EXPECTED_TITLE_CHEAPEST_CHARGER_XPATH = "//*[contains(@class, 'product-card__content')]//*[@title='Зарядний пристрій Google Pixel Charger 30W']";
    ...
    public String sortedByChargerPhonePageUrl = "https://allo.ua/ua/catalogsearch/result/index/dir-asc/order-price" +
